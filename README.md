 ...
 **<h3 align="left">🚀 Experienced full-stack developer with a strong focus on the MEAN stack (MongoDB, Express.js, Angular, Node.js) and Java Spring Boot. Skilled in building scalable web applications, designing secure system architectures, and delivering modern front-end and back-end solutions. Proficient in Agile methodologies, CI/CD pipelines, and cloud-based technologies. Passionate about clean, maintainable code and committed to SOLID principles and best practices in software architecture.</h3>**
